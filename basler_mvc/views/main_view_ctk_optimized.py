...
class ColorScheme:
    ...
    SUCCESS_GREEN = "#10b981"     # 清晰綠色
    WARNING_ORANGE = "#f59e0b"    # 明亮橙色
    ERROR_RED = "#ef4444"         # 清晰紅色
    PURPLE_ACCENT = "#8b5cf6"     # 明亮紫色
    
    # 文字顏色 - 深色文字在淺色背景上更清楚
    TEXT_PRIMARY = "#1f2937"      # 深灰色主要文字
    TEXT_SECONDARY = "#6b7280"    # 中灰色次要文字
    TEXT_ACCENT = "#2563eb"       # 藍色強調文字
    
    # 背景顏色 - 明亮清晰
    BG_LIGHT = "#f8fafc"         # 淺色主背景
    BG_CARD = "#ffffff"          # 白色卡片背景
    BG_SECONDARY = "#f1f5f9"     # 次要背景
